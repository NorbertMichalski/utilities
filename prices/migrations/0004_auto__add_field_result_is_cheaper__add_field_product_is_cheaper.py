...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.is_cheaper'
        db.add_column(u'prices_result', 'is_cheaper',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.is_cheaper'
        db.add_column(u'prices_product', 'is_cheaper',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.is_cheaper'
        db.delete_column(u'prices_result', 'is_cheaper')

        # Deleting field 'Product.is_cheaper'
        db.delete_column(u'prices_product', 'is_cheaper')
    ...
    models = {
        ...
        u'prices.product': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_cheaper': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
